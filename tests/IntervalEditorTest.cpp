...
void IntervalEditorTest::initTestCase()
{
...
void IntervalEditorTest::cleanupTestCase()
{
    tsplot->hide();
    delete tsplot;
}

void IntervalEditorTest::createAndDestroyIntervalEditorModule()
{
    ieModule = tsplot->addIntervalEditorModule ( "testData/IntervalEditorTest" );
    QVERIFY( ieModule != NULL );
    bool result = tsplot->deleteModule( ieModule );
    QVERIFY( result == true );
}


#include "IntervalEditorTest.moc"
